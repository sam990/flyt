...
void launch_kernel(long *d_a, long *d_b, long list_size, long iterations, long *h_b) {
		    ...
		    timespec ts_start, ts_end;
			    ...
			    add<<<grid_size,block_size>>>(iterations, d_a, d_b);
				    ...
				    clock_gettime(CLOCK_MONOTONIC, &ts_end);
				        ...
				        HANDLE_ERROR(cudaMemcpy(h_b, d_a, list_size * sizeof(long), cudaMemcpyDeviceToHost));
